...
- [M1.2.5: Mapping Rule References, Ruleset Versioning, and Target BPMN Profile Propagation](M1-2-5-mapping-rule-target-profile-propagation.md), Proposed / In progress for design only; REV-0012 Request changes, Proposed corrections pending REV-0013.
