...
- The Proposed correction binds one immutable candidate-enumeration policy into each ruleset closure, adds authoritative candidate-universe provenance, and defines a normative inherited-diagnostic trigger and precedence matrix. Both findings remain pending REV-0013.
