...
- M1.2 Process IR Machine-Readiness Hardening is proposed design work for making the accepted Process IR contract ready for machine representation. M1.2.1 through M1.2.4 are completed as design-contract work. M1.2.5 is the only active narrow design item. Implementation remains limited to documentation and governance. M1.2 as a whole is not completed.
...
- M1.2.5 Mapping Rule References, Ruleset Versioning, and Target BPMN Profile Propagation is Proposed and in progress for design only through [Issue #20](https://github.com/ThresholdOps/MotiveForce/issues/20), [DEC-0009](decisions/DEC-0009-mapping-rule-target-profile-propagation.md), and the [M1.2.5 milestone](milestones/M1-2-5-mapping-rule-target-profile-propagation.md). It defines no mapping engine, compiler, Kernel, profile registry, metamodel, schema, runtime, API, persistence, UI, tests, or CI.
...
| Mapping-rule references, ruleset versioning, and target BPMN profile propagation | Proposed | In progress for design only | [Issue #20](https://github.com/ThresholdOps/MotiveForce/issues/20), [M1.2](milestones/M1-2-process-ir-machine-readiness.md), [M1.2.5](milestones/M1-2-5-mapping-rule-target-profile-propagation.md), [DEC-0009](decisions/DEC-0009-mapping-rule-target-profile-propagation.md) |
