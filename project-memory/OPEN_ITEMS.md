...
| `OPEN-0021` | Merge strategy for reviewed and bounded-finalization PRs | Governance | Proposed | In progress for governance design only | [Issue #28](https://github.com/ThresholdOps/MotiveForce/issues/28), branch `agent/merge-strategy-governance` | [DEC-0011](decisions/DEC-0011-reviewed-finalization-merge-strategy.md), Proposed; [DEC-0004](decisions/DEC-0004-project-memory-governance.md), Accepted and unchanged | PR #29 allocates `OPEN-0020` and `DEC-0010`; Issue #28 must resolve before REV-0014. | Obtain a human governance decision against the exact Draft PR head; do not start REV-0014. |
...
1. Review Proposed [DEC-0011](decisions/DEC-0011-reviewed-finalization-merge-strategy.md) through the standalone Draft PR for [Issue #28](https://github.com/ThresholdOps/MotiveForce/issues/28).
2. Keep REV-0014 blocked until Issue #28 is accepted and merged.
