...
| `OPEN-0018` | Mapping-rule references, ruleset versioning, and target BPMN profile propagation | Design | Proposed | In progress for design only | [Issue #20](https://github.com/ThresholdOps/MotiveForce/issues/20), Draft [PR #26](https://github.com/ThresholdOps/MotiveForce/pull/26), branch `design/m1-2-5-mapping-profile-propagation`, REV-0012 reviewed head [`7a6ec176`](https://github.com/ThresholdOps/MotiveForce/commit/7a6ec176a0fcc738a5c56a9c98a7d946446a2c01) | [M1.2](milestones/M1-2-process-ir-machine-readiness.md), [M1.2.5](milestones/M1-2-5-mapping-rule-target-profile-propagation.md), [DEC-0009](decisions/DEC-0009-mapping-rule-target-profile-propagation.md), [REV-0011](reviews/M1-2-5-mapping-rule-target-profile-propagation-review.md), [REV-0012](reviews/M1-2-5-mapping-rule-target-profile-propagation-review-2.md) | REV-0012 retained the architecture and requested two bounded corrections. Both have Proposed author corrections, and three bounded reviewer-attention clarifications are recorded, pending REV-0013; DEC-0009 remains Proposed and no implementation or merge authorization exists. | Validate the bounded correction and obtain human semantic and design re-review under REV-0013. |
...
1. Complete validation and obtain human semantic and design re-review under REV-0013 of the Proposed REV-0012 corrections and the three bounded reviewer-attention clarifications through [Issue #20](https://github.com/ThresholdOps/MotiveForce/issues/20) and Draft [PR #26](https://github.com/ThresholdOps/MotiveForce/pull/26).
2. Keep Issues [#6](https://github.com/ThresholdOps/MotiveForce/issues/6), [#8](https://github.com/ThresholdOps/MotiveForce/issues/8), [#9](https://github.com/ThresholdOps/MotiveForce/issues/9), and [#21](https://github.com/ThresholdOps/MotiveForce/issues/21) deferred and not started.
