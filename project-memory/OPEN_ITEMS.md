...
| `OPEN-0018` | Mapping-rule references, ruleset versioning, and target BPMN profile propagation | Design | Accepted | Completed for design contract through merge; runtime implementation not started | [Issue #20](https://github.com/ThresholdOps/MotiveForce/issues/20), [PR #26](https://github.com/ThresholdOps/MotiveForce/pull/26), branch `design/m1-2-5-mapping-profile-propagation`, REV-0013 reviewed head [`f8d2249e`](https://github.com/ThresholdOps/MotiveForce/commit/f8d2249e4693305b57bf021c76bdd78b010da24b) | [M1.2](milestones/M1-2-process-ir-machine-readiness.md), [M1.2.5](milestones/M1-2-5-mapping-rule-target-profile-propagation.md), [DEC-0009](decisions/DEC-0009-mapping-rule-target-profile-propagation.md), [REV-0011](reviews/M1-2-5-mapping-rule-target-profile-propagation-review.md), [REV-0012](reviews/M1-2-5-mapping-rule-target-profile-propagation-review-2.md), [REV-0013](reviews/M1-2-5-mapping-rule-target-profile-propagation-review-3.md) | REV-0013 closes both REV-0012 findings, approves all three section 26.1 clarifications, and accepts all 15 design choices through merge of PR #26. | Merge PR #26 after bounded-finalization validation, then close Issue #20. |
...
| `OPEN-0021` | Merge strategy for reviewed and bounded-finalization PRs | Governance | Accepted | Completed through merge | [Issue #28](https://github.com/ThresholdOps/MotiveForce/issues/28), [PR #30](https://github.com/ThresholdOps/MotiveForce/pull/30), reviewed head [`e0020a44`](https://github.com/ThresholdOps/MotiveForce/commit/e0020a44b0b649b711402d282d4cf5ece31708a8), [human governance decision](https://github.com/ThresholdOps/MotiveForce/pull/30#issuecomment-5165269810) | [DEC-0011](decisions/DEC-0011-reviewed-finalization-merge-strategy.md), Accepted through merge; [DEC-0004](decisions/DEC-0004-project-memory-governance.md), Accepted and unchanged | PR #29 allocates `OPEN-0020` and `DEC-0010`; the merge-strategy gate is resolved. | No further review unless a later decision supersedes DEC-0011. |
...
1. Synchronize PR #29 only to the new `main` base and resolved Issue #28 gate, including PR #30's actual merge SHA under the DEC-0004 self-provenance rule.
2. Keep REV-0014 unstarted until that bounded synchronization is complete; do not improve the M1.2.6 semantic contract before review.
3. Keep Issues [#6](https://github.com/ThresholdOps/MotiveForce/issues/6), [#8](https://github.com/ThresholdOps/MotiveForce/issues/8), [#9](https://github.com/ThresholdOps/MotiveForce/issues/9), and [#21](https://github.com/ThresholdOps/MotiveForce/issues/21) deferred and not started.
