...
1. Consider [Issue #19](https://github.com/ThresholdOps/MotiveForce/issues/19) as the next candidate for a conscious M1.2 start without marking it started.
2. Keep Issues [#8](https://github.com/ThresholdOps/MotiveForce/issues/8) and [#19](https://github.com/ThresholdOps/MotiveForce/issues/19)-[#21](https://github.com/ThresholdOps/MotiveForce/issues/21) deferred and not started.
