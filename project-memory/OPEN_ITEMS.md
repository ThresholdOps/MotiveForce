...
| `OPEN-0014` | Process IR record envelope and revision semantics | Design | Open | Deferred in current phase | Created [Issue #16](https://github.com/ThresholdOps/MotiveForce/issues/16) | [M1.2](milestones/M1-2-process-ir-machine-readiness.md) | M1 acceptance is satisfied. | During M1.2 planning. |
...
| `OPEN-0017` | AnalystDecision staleness and invalidation rules | Design | Open | Deferred in current phase | Created [Issue #19](https://github.com/ThresholdOps/MotiveForce/issues/19) | [M1.2](milestones/M1-2-process-ir-machine-readiness.md) | Decision authority and context semantics. | During M1.2 planning. |
...
| --- | --- | --- | --- |
| `ASM-0001` | `origin/main` at verification time is [`54d5e814601788574d13761561867ce5982cc88c`](https://github.com/ThresholdOps/MotiveForce/commit/54d5e814601788574d13761561867ce5982cc88c). | Git fetch and PR #2 metadata. | Verified 2026-07-23T08:08:27Z. |
...
1. Resolve [Issue #4](https://github.com/ThresholdOps/MotiveForce/issues/4) now that PR #2 semantic acceptance is complete.
2. Use the accepted update-discipline and self-provenance rules in the next governance-affecting PR.
