...
| `OPEN-0018` | Mapping-rule references, ruleset versioning, and target BPMN profile propagation | Design | Proposed | In progress for design only | [Issue #20](https://github.com/ThresholdOps/MotiveForce/issues/20), Draft [PR #26](https://github.com/ThresholdOps/MotiveForce/pull/26), branch `design/m1-2-5-mapping-profile-propagation`, reviewed head [`1cb85a81`](https://github.com/ThresholdOps/MotiveForce/commit/1cb85a81b00bce4729bfc2ce58ad871ab67ee1d0) | [M1.2](milestones/M1-2-process-ir-machine-readiness.md), [M1.2.5](milestones/M1-2-5-mapping-rule-target-profile-propagation.md), [DEC-0009](decisions/DEC-0009-mapping-rule-target-profile-propagation.md), [REV-0011](reviews/M1-2-5-mapping-rule-target-profile-propagation-review.md) | REV-0011 retained the architecture and requested four bounded corrections. DEC-0009 remains Proposed; no implementation or merge authorization exists. | Human semantic and design re-review under REV-0012. |
...
1. Obtain human semantic and design re-review under REV-0012 of corrected M1.2.5 through [Issue #20](https://github.com/ThresholdOps/MotiveForce/issues/20) and Draft [PR #26](https://github.com/ThresholdOps/MotiveForce/pull/26).
