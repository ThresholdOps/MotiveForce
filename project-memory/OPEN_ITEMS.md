...
1. Merge [PR #26](https://github.com/ThresholdOps/MotiveForce/pull/26) after bounded-finalization validation, then close [Issue #20](https://github.com/ThresholdOps/MotiveForce/issues/20).
