...
1. Consider [Issue #18](https://github.com/ThresholdOps/MotiveForce/issues/18) as a candidate for the next conscious M1.2 start without marking it started.
2. Keep Issues [#8](https://github.com/ThresholdOps/MotiveForce/issues/8) and [#18](https://github.com/ThresholdOps/MotiveForce/issues/18)-[#21](https://github.com/ThresholdOps/MotiveForce/issues/21) deferred until deliberately started.
