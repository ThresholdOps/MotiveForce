...
- [DEC-0009: Mapping Rule References and Target BPMN Profile Propagation](DEC-0009-mapping-rule-target-profile-propagation.md), Proposed; REV-0012 requested two bounded changes, Proposed corrections are recorded, and human re-review under REV-0013 is required.
